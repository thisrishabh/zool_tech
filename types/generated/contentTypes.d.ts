...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    middle: Attribute.Component<'page.a-middle'>;
    gallery: Attribute.Component<'page.gallery'>;
    video: Attribute.Media;
    team: Attribute.Component<'page.team', true>;
    name: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiContactContact extends Schema.SingleType {
  ...
  attributes: {
    ...
    main: Attribute.Component<'page.main'>;
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    footer: Attribute.Component<'page.footer', true>;
    main: Attribute.Component<'page.main'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    main: Attribute.Component<'page.main'>;
    middle: Attribute.Component<'page.middle', true>;
    gallery: Attribute.Component<'page.gallery'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiLabLab extends Schema.SingleType {
  ...
  attributes: {
    header: Attribute.Component<'page.header'>;
    middle: Attribute.Component<'page.a-middle'>;
    inovation: Attribute.Component<'page.middle', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiRecentBlogRecentBlog extends Schema.CollectionType {
  collectionName: 'recent_blogs';
  info: {
    singularName: 'recent-blog';
    pluralName: 'recent-blogs';
    displayName: 'Recent_Blog';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::recent-blog.recent-blog': ApiRecentBlogRecentBlog;
    }
  }
}
